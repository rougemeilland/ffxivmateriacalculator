...
namespace MasterDataGenerator
{
    class Program
    {
        ...
        private static void GenerateMasterData()
        {
            ...
            {
                new { /*minimu_item_level = 15,*/ default_catalyst = "コールマターG1", catalysts = new[] { "コールマターG1","コールマターG2","コールマターG3","コールマターG4","コールマターG5" }, success_rates_nq = new[] { 40, 20, 10, 5 }, success_rates_hq = new[] { 45, 24, 14, 8 }, name_ja = "マテリア", name_en = "I", name_de = "I", name_fr = "I" },
                new { /*minimu_item_level = 30,*/ default_catalyst = "コールマターG2", catalysts = new[] { "コールマターG2","コールマターG3","コールマターG4","コールマターG5" }, success_rates_nq = new[] { 36, 18, 9, 5 }, success_rates_hq = new[] { 41, 22, 13, 8 }, name_ja = "マテリラ", name_en = "II", name_de = "II", name_fr = "II" },
                new { /*minimu_item_level = 45,*/ default_catalyst = "コールマターG3", catalysts = new[] { "コールマターG3","コールマターG4","コールマターG5" }, success_rates_nq = new[] { 30, 15, 8, 4 }, success_rates_hq = new[] { 35, 19, 11, 7 }, name_ja = "マテリダ", name_en = "III", name_de = "III", name_fr = "III" },
                new { /*minimu_item_level = 55,*/ default_catalyst = "コールマターG4", catalysts = new[] { "コールマターG4","コールマターG5" }, success_rates_nq = new[] { 24, 12, 6, 3 }, success_rates_hq = new[] { 29, 16, 10, 6 }, name_ja = "マテリガ", name_en = "IV", name_de = "IV", name_fr = "IV" },
                new { /*minimu_item_level = 160,*/ default_catalyst = "コールマターG5", catalysts = new[] { "コールマターG5" }, success_rates_nq = new[] { 12, 6, 3, 2 }, success_rates_hq = new[] { 17, 10, 7, 5 }, name_ja = "マテリジャ", name_en = "V", name_de = "V", name_fr = "V" },
            };
            var status_source = new[]
            {
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "STR", materia_name_ja = "剛力の{0}", name_en = "Strength", materia_name_en = "Strength Materia {0}", name_de = "Stärke", materia_name_de = "Stärke-Materia {0}", name_fr = "Force", materia_name_fr = "Matéria de force {0}" },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "VIT", materia_name_ja = "活力の{0}", name_en = "Vitality", materia_name_en = "Vitality Materia {0}", name_de = "Konstitution", materia_name_de = "Konstitutions-Materia {0}", name_fr = "Vitalité", materia_name_fr = "Matéria de vitalité {0}" },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "DEX", materia_name_ja = "眼力の{0}", name_en = "Dexterity", materia_name_en = "Dexterity Materia {0}", name_de = "Geschick", materia_name_de = "Geschicklichkeits-Materia {0}", name_fr = "Dextérité", materia_name_fr = "Matéria de dextérité {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "INT", materia_name_ja = "知力の{0}", name_en = "Intelligence", materia_name_en = "Intelligence Materia {0}", name_de = "Intelligenz", materia_name_de = "Intelligenz-Materia {0}", name_fr = "Intelligence", materia_name_fr = "Matéria d'intelligence {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "MND", materia_name_ja = "心力の{0}", name_en = "Mind", materia_name_en = "Mind Materia {0}", name_de = "Willenskraft", materia_name_de = "Willenskraft-Materia {0}", name_fr = "Esprit", materia_name_fr = "Matéria d'esprit {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "PIE", materia_name_ja = "信力の{0}", name_en = "Piety", materia_name_en = "Piety Materia {0}", name_de = "Frömmigkeit", materia_name_de = "Frömmigkeits-Materia {0}", name_fr = "Piété", materia_name_fr = "Matéria de piété {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "火", materia_name_ja = "防火の{0}", name_en = "Fire Resistance", materia_name_en = "Fire Materia {0}", name_de = "Feuerresistenz", materia_name_de = "Feuer-Materia {0}", name_fr = "Résistance au feu", materia_name_fr = "Matéria pyrovoile {0}" },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "氷", materia_name_ja = "防氷の{0}", name_en = "Ice Resistance", materia_name_en = "Ice Materia {0}", name_de = "Eisresistenz", materia_name_de = "Eis-Materia {0}", name_fr = "Résistance à la glace", materia_name_fr = "Matéria cryovoile {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "風", materia_name_ja = "防風の{0}", name_en = "Wind Resistance", materia_name_en = "Wind Materia {0}", name_de = "Windresistenz", materia_name_de = "Wind-Materia {0}", name_fr = "Résistance au vent", materia_name_fr = "Matéria aérovoile {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "土", materia_name_ja = "防土の{0}", name_en = "Earth Resistance", materia_name_en = "Earth Materia {0}", name_de = "Erdresistenz", materia_name_de = "Erd-Materia {0}", name_fr = "Résistance à la terre", materia_name_fr = "Matéria géovoile {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "雷", materia_name_ja = "防雷の{0}", name_en = "Lightning Resistance", materia_name_en = "Lightning Materia {0}", name_de = "Blitzresistenz", materia_name_de = "Blitz-Materia {0}", name_fr = "Résistance à la foudre", materia_name_fr = "Matéria électrovoile {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "水", materia_name_ja = "防水の{0}", name_en = "Water Resistance", materia_name_en = "Water Materia {0}", name_de = "Wasserresistenz", materia_name_de = "Wasser-Materia {0}", name_fr = "Résistance à l'eau", materia_name_fr = "Matéria hydrovoile {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "命中力", materia_name_ja = "天眼の{0}", name_en = "Accuracy", materia_name_en = "Heavens' Eye Materia {0}", name_de = "Präzision", materia_name_de = "Hellseher-Materia {0}", name_fr = "Précision", materia_name_fr = "Matéria du regard divin {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "クリティカル", materia_name_ja = "武略の{0}", name_en = "Critical Hit Rate", materia_name_en = "Savage Aim Materia {0}", name_de = "Kritische Treffer", materia_name_de = "Strategen-Materia {0}", name_fr = "Critique", materia_name_fr = "Matéria de la barbarie maîtrisée {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "意志力", materia_name_ja = "雄略の{0}", name_en = "Determination", materia_name_en = "Savage Might Materia {0}", name_de = "Entschlossenheit", materia_name_de = "Assassinen-Materia {0}", name_fr = "Détermination", materia_name_fr = "Matéria de la barbarie percutante {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "受け流し発動力", materia_name_ja = "剛柔の{0}", name_en = "Parry", materia_name_en = "Battledance Materia {0}", name_de = "Parade", materia_name_de = "Fechtkunst-Materia {0}", name_fr = "Parade", materia_name_fr = "Matéria de la parade stratégique {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "獲得力", materia_name_ja = "達識の{0}", name_en = "Gathering", materia_name_en = "Gatherer's Guerdon Materia {0}", name_de = "Sammelgeschick", materia_name_de = "Sammlersold-Materia {0}", name_fr = "Collecte", materia_name_fr = "Matéria de la collecte {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "識質力", materia_name_ja = "博識の{0}", name_en = "Perception", materia_name_en = "Gatherer's Guile Materia {0}", name_de = "Wahrnehmung", materia_name_de = "Sammlerschlich-Materia {0}", name_fr = "Discernement", materia_name_fr = "Matéria du discernement {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "GP", materia_name_ja = "器識の{0}", name_en = "GP", materia_name_en = "Gatherer's Grasp Materia {0}", name_de = "SP", materia_name_de = "Sammlersinn-Materia {0}", name_fr = "PR", materia_name_fr = "Matéria du rendement {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "作業精度", materia_name_ja = "名匠の{0}", name_en = "Craftsmanship", materia_name_en = "Craftsman's Competence Materia {0}", name_de = "Kunstfertigkeit", materia_name_de = "Facharbeiter-Materia {0}", name_fr = "Habileté", materia_name_fr = "Matéria de l'art physique {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "CP", materia_name_ja = "魔匠の{0}", name_en = "CP", materia_name_en = "Craftsman's Cunning Materia {0}", name_de = "HP", materia_name_de = "Fachwissen-Materia {0}", name_fr = "PS", materia_name_fr = "Matéria de l'art magique {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "加工精度", materia_name_ja = "巨匠の{0}", name_en = "Control", materia_name_en = "Craftsman's Command Materia {0}", name_de = "Kontrolle", materia_name_de = "Fachkenntnis-Materia {0}", name_fr = "Contrôle", materia_name_fr = "Matéria du contrôle {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "スキルスピード", materia_name_ja = "戦技の{0}", name_en = "Skill Speed", materia_name_en = "Quickarm Materia {0}", name_de = "Schnelligkeit", materia_name_de = "Kampf-Materia {0}", name_fr = "Vivacité", materia_name_fr = "Matéria de la vivacité {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ"}, name_ja = "スペルスピード", materia_name_ja = "詠唱の{0}", name_en = "Spell Speed", materia_name_en = "Quicktongue Materia {0}", name_de = "Zaubertempo", materia_name_de = "Zauber-Materia {0}", name_fr = "Célérité", materia_name_fr = "Matéria de la célérité {0}"  },
            };
            var catalysts_source = new[]
            {
                new { name_ja = "コールマターG1", grades = new[] { "マテリア" }, name_en = "Grade 1 Carbonized Matter", name_de = "Karbonisierte Materie G1", name_fr = "Matière carbonique grade I" },
                new { name_ja = "コールマターG2", grades = new[] { "マテリア", "マテリラ" }, name_en = "Grade 2 Carbonized Matter", name_de = "Karbonisierte Materie G2", name_fr = "Matière carbonique grade II" },
                new { name_ja = "コールマターG3", grades = new[] { "マテリア", "マテリラ", "マテリダ" }, name_en = "Grade 3 Carbonized Matter", name_de = "Karbonisierte Materie G3", name_fr = "Matière carbonique grade III" },
                new { name_ja = "コールマターG4", grades = new[] { "マテリア", "マテリラ", "マテリダ", "マテリガ" }, name_en = "Grade 4 Carbonized Matter", name_de = "Karbonisierte Materie G4", name_fr = "Matière carbonique grade IV" },
                new { name_ja = "コールマターG5", grades = new[] { "マテリア", "マテリラ", "マテリダ", "マテリガ", "マテリジャ" }, name_en = "Grade 5 Carbonized Matter", name_de = "Karbonisierte Materie G5", name_fr = "Matière carbonique grade V" },
            };
            ...
            var default_item_prices_source = new[]
            {
                ...
                new { name_ja = "コールマターG1", price = 170 },
                new { name_ja = "コールマターG2", price = 65 },
                new { name_ja = "コールマターG3", price = 190 },
                new { name_ja = "コールマターG4", price = 900 },
                new { name_ja = "コールマターG5", price = 1500 },
            };
            var official_site_item_ids_source = new[]
            {
                ...
                new { db_id = "5f4c5a1b68a", name_ja = "コールマターG1" },
                new { db_id = "1e58e73d734", name_ja = "コールマターG2" },
                new { db_id = "49b6549e5f3", name_ja = "コールマターG3" },
                new { db_id = "bcd7cdcdb70", name_ja = "コールマターG4" },
                new { db_id = "dd08766b124", name_ja = "コールマターG5" },
            };
            var gil_names = new[]
            {
            ...
            var items = status_source
                        ...
                        .Concat(catalysts_source
                                .Where(c => c.name_ja != null)
                                .Select(c =>
                                {
                                    var id = new GlobalID(c.name_en);
                                    return (new
                                    {
                                        id,
                                        name = new MultiLanguageString(ja: c.name_ja, en: c.name_en, de: c.name_de, fr: c.name_fr),
                                    });
                                }))
            ...
            var grades = grades_source
                         .Select((gs, index) =>
                         {
                             var default_catalyst_id = catalysts_source
                                                       .Select((cs, c_index) => new { name = cs.name_ja, c_index })
                                                       .Where(item => gs.default_catalyst == item.name)
                                                       .Select(item => (CatalystID)(item.c_index + 1))
                                                       .Single();
                             var catalyst_ids = catalysts_source
                                                .Select((cs, c_index) => new { name = cs.name_ja, c_index })
                                                .Where(item => gs.catalysts.Any(c => c == item.name))
                                                .Select(item => (CatalystID)(item.c_index + 1))
                                                .ToArray();
                         ...
                         .Where(item => item.CatalystIDs != null)
            ...
            var catalysts = catalysts_source
                            .Select((cs, index) =>
                            {
                                var grade_ids = grades_source
                                                .Select((gs, g_index) => new { name = gs.name_ja, g_index })
                                                .Where(item => cs.grades.Any(g => g == item.name))
                                                .Select(item => (GradeID)(item.g_index + 1))
                                                .ToArray();
                                var item_id = cs.name_ja != null ? items_indexed_by_name[cs.name_ja].ItemID : ItemID.None;
                                return (new Catalyst((CatalystID)(index + 1),
                                                     new MultiLanguageString(ja: cs.name_ja, en: cs.name_en, de: cs.name_de, fr: cs.name_fr),
                                                     grade_ids,
                                                     item_id));
                            })
                            .ToDictionary(item => item.CatalystID, item => item);
            var catalysts_indexed_by_name = catalysts.Values
                                            .SelectMany(item => new[]
                                                                {
                                                                    item.Name["en"],
                                                                    item.Name["de"],
        ...
        private static object SerializeToObject(IDictionary<CatalystID, Catalyst> o)
        {
            var max = o.Keys.Max();
            var array_size = max - CatalystID.None + 1;
            var array = new object[array_size];
            foreach (var item in o)
                array[item.Key - CatalystID.None] = item.Value.SerializeToObject();
            return (array);
        }
        ...
        */
        ...
        private static void WriteToJSONFile(IDictionary<ItemID, Item> items, IDictionary<GradeID, Grade> grades, IDictionary<StatusID, Status> status, IDictionary<CatalystID, Catalyst> catalysts, IDictionary<MateriaID, Materia> materias, IDictionary<string, object> storage_items, MultiLanguageString gil_name, IDictionary<GlobalID, string> default_item_prices)
        {
            ...
            {
                RenderToJSONFile(writer, items, grades, status, catalysts, materias, storage_items, gil_name, default_item_prices);
                writer.Flush();
            }
        }

        private static void WriteToJSONGzipFile(IDictionary<ItemID, Item> items, IDictionary<GradeID, Grade> grades, IDictionary<StatusID, Status> status, IDictionary<CatalystID, Catalyst> catalysts, IDictionary<MateriaID, Materia> materias, IDictionary<string, object> storage_items, MultiLanguageString gil_name, IDictionary<GlobalID, string> default_item_prices)
        {
        ...
        private static void RenderToJSONFile(StreamWriter writer, IDictionary<ItemID, Item> items, IDictionary<GradeID, Grade> grades, IDictionary<StatusID, Status> status, IDictionary<CatalystID, Catalyst> catalysts, IDictionary<MateriaID, Materia> materias, IDictionary<string, object> storage_items, MultiLanguageString gil_name, IDictionary<GlobalID, string> default_item_prices)
        {
            var dic = new Dictionary<string, object>();
            dic["items"] = SerializeToObject(items);
            dic["grades"] = SerializeToObject(grades);
            dic["status"] = SerializeToObject(status);
            dic["catalysts"] = SerializeToObject(catalysts);
