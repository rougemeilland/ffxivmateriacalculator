    ...
    class Program
    {
        ...
        private static void GenerateMasterData()
        {
            var grades_source = new[]
            {
                ...
                new { success_rates_nq = new[] { 0, 0, 0, 0 }, success_rates_hq = new[] { 0, 0, 0, 0 }, name_ja = "ハイマテリジャ", name_en = "VI", name_de = "VI", name_fr = "VI" },
            };
            var status_source = new[]
            {
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "STR", materia_name_ja = "剛力の{0}", name_en = "Strength", materia_name_en = "Strength Materia {0}", name_de = "Stärke", materia_name_de = "Stärke-Materia {0}", name_fr = "Force", materia_name_fr = "Matéria de force {0}" },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "VIT", materia_name_ja = "活力の{0}", name_en = "Vitality", materia_name_en = "Vitality Materia {0}", name_de = "Konstitution", materia_name_de = "Konstitutions-Materia {0}", name_fr = "Vitalité", materia_name_fr = "Matéria de vitalité {0}" },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "DEX", materia_name_ja = "眼力の{0}", name_en = "Dexterity", materia_name_en = "Dexterity Materia {0}", name_de = "Geschick", materia_name_de = "Geschicklichkeits-Materia {0}", name_fr = "Dextérité", materia_name_fr = "Matéria de dextérité {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "INT", materia_name_ja = "知力の{0}", name_en = "Intelligence", materia_name_en = "Intelligence Materia {0}", name_de = "Intelligenz", materia_name_de = "Intelligenz-Materia {0}", name_fr = "Intelligence", materia_name_fr = "Matéria d'intelligence {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "MND", materia_name_ja = "心力の{0}", name_en = "Mind", materia_name_en = "Mind Materia {0}", name_de = "Willenskraft", materia_name_de = "Willenskraft-Materia {0}", name_fr = "Esprit", materia_name_fr = "Matéria d'esprit {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "火", materia_name_ja = "防火の{0}", name_en = "Fire Resistance", materia_name_en = "Fire Materia {0}", name_de = "Feuerresistenz", materia_name_de = "Feuer-Materia {0}", name_fr = "Résistance au feu", materia_name_fr = "Matéria pyrovoile {0}" },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "氷", materia_name_ja = "防氷の{0}", name_en = "Ice Resistance", materia_name_en = "Ice Materia {0}", name_de = "Eisresistenz", materia_name_de = "Eis-Materia {0}", name_fr = "Résistance à la glace", materia_name_fr = "Matéria cryovoile {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "風", materia_name_ja = "防風の{0}", name_en = "Wind Resistance", materia_name_en = "Wind Materia {0}", name_de = "Windresistenz", materia_name_de = "Wind-Materia {0}", name_fr = "Résistance au vent", materia_name_fr = "Matéria aérovoile {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "土", materia_name_ja = "防土の{0}", name_en = "Earth Resistance", materia_name_en = "Earth Materia {0}", name_de = "Erdresistenz", materia_name_de = "Erd-Materia {0}", name_fr = "Résistance à la terre", materia_name_fr = "Matéria géovoile {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "雷", materia_name_ja = "防雷の{0}", name_en = "Lightning Resistance", materia_name_en = "Lightning Materia {0}", name_de = "Blitzresistenz", materia_name_de = "Blitz-Materia {0}", name_fr = "Résistance à la foudre", materia_name_fr = "Matéria électrovoile {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "水", materia_name_ja = "防水の{0}", name_en = "Water Resistance", materia_name_en = "Water Materia {0}", name_de = "Wasserresistenz", materia_name_de = "Wasser-Materia {0}", name_fr = "Résistance à l'eau", materia_name_fr = "Matéria hydrovoile {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "ダイレクトヒット", materia_name_ja = "天眼の{0}", name_en = "Direct Hit Rate", materia_name_en = "Heavens' Eye Materia {0}", name_de = "Direkter Treffer", materia_name_de = "Hellseher-Materia {0}", name_fr = "Coups nets", materia_name_fr = "Matéria du regard divin {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "クリティカル", materia_name_ja = "武略の{0}", name_en = "Critical Hit Rate", materia_name_en = "Savage Aim Materia {0}", name_de = "Kritische Treffer", materia_name_de = "Strategen-Materia {0}", name_fr = "Critique", materia_name_fr = "Matéria de la barbarie maîtrisée {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "意志力", materia_name_ja = "雄略の{0}", name_en = "Determination", materia_name_en = "Savage Might Materia {0}", name_de = "Entschlossenheit", materia_name_de = "Assassinen-Materia {0}", name_fr = "Détermination", materia_name_fr = "Matéria de la barbarie percutante {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "不屈", materia_name_ja = "剛柔の{0}", name_en = "Tenacity", materia_name_en = "Battledance Materia {0}", name_de = "Unbeugsamkeit", materia_name_de = "Fechtkunst-Materia {0}", name_fr = "Ténacité", materia_name_fr = "Matéria de la parade stratégique {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "信仰", materia_name_ja = "信力の{0}", name_en = "Piety", materia_name_en = "Piety Materia {0}", name_de = "Frömmigkeit", materia_name_de = "Frömmigkeits-Materia {0}", name_fr = "Piété", materia_name_fr = "Matéria de piété {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "獲得力", materia_name_ja = "達識の{0}", name_en = "Gathering", materia_name_en = "Gatherer's Guerdon Materia {0}", name_de = "Sammelgeschick", materia_name_de = "Sammlersold-Materia {0}", name_fr = "Collecte", materia_name_fr = "Matéria de la collecte {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "識質力", materia_name_ja = "博識の{0}", name_en = "Perception", materia_name_en = "Gatherer's Guile Materia {0}", name_de = "Wahrnehmung", materia_name_de = "Sammlerschlich-Materia {0}", name_fr = "Discernement", materia_name_fr = "Matéria du discernement {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "GP", materia_name_ja = "器識の{0}", name_en = "GP", materia_name_en = "Gatherer's Grasp Materia {0}", name_de = "SP", materia_name_de = "Sammlersinn-Materia {0}", name_fr = "PR", materia_name_fr = "Matéria du rendement {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "作業精度", materia_name_ja = "名匠の{0}", name_en = "Craftsmanship", materia_name_en = "Craftsman's Competence Materia {0}", name_de = "Kunstfertigkeit", materia_name_de = "Facharbeiter-Materia {0}", name_fr = "Habileté", materia_name_fr = "Matéria de l'art physique {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "CP", materia_name_ja = "魔匠の{0}", name_en = "CP", materia_name_en = "Craftsman's Cunning Materia {0}", name_de = "HP", materia_name_de = "Fachwissen-Materia {0}", name_fr = "PS", materia_name_fr = "Matéria de l'art magique {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "加工精度", materia_name_ja = "巨匠の{0}", name_en = "Control", materia_name_en = "Craftsman's Command Materia {0}", name_de = "Kontrolle", materia_name_de = "Fachkenntnis-Materia {0}", name_fr = "Contrôle", materia_name_fr = "Matéria du contrôle {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "スキルスピード", materia_name_ja = "戦技の{0}", name_en = "Skill Speed", materia_name_en = "Quickarm Materia {0}", name_de = "Schnelligkeit", materia_name_de = "Kampf-Materia {0}", name_fr = "Vivacité", materia_name_fr = "Matéria de la vivacité {0}"  },
                new { grades = new[] { "マテリア","マテリラ","マテリダ","マテリガ","マテリジャ","ハイマテリジャ"}, name_ja = "スペルスピード", materia_name_ja = "詠唱の{0}", name_en = "Spell Speed", materia_name_en = "Quicktongue Materia {0}", name_de = "Zaubertempo", materia_name_de = "Zauber-Materia {0}", name_fr = "Célérité", materia_name_fr = "Matéria de la célérité {0}"  },
            };
